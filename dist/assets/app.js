...
var css = "[data-component=\"Widgets/AxesWidget\"] .display-panel{padding:0 5px 5px;border-bottom:1px solid #ddd}[data-component=\"Widgets/AxesWidget\"] .display-panel .axis-label{text-align:center;width:1%;font-size:30px;padding:0 10px}[data-component=\"Widgets/AxesWidget\"] .display-panel .axis-position{padding:0 10px;text-align:right;white-space:nowrap}[data-component=\"Widgets/AxesWidget\"] .display-panel .axis-position .decimal-point,[data-component=\"Widgets/AxesWidget\"] .display-panel .axis-position .fractional-part,[data-component=\"Widgets/AxesWidget\"] .display-panel .axis-position .integer-part{font-size:30px}[data-component=\"Widgets/AxesWidget\"] .display-panel .axis-position .dimension-unit{font-size:14px}[data-component=\"Widgets/AxesWidget\"] .display-panel .axis-position .integer-part{width:90px;text-align:right}[data-component=\"Widgets/AxesWidget\"] .display-panel .axis-position .dimension-unit{vertical-align:top}[data-component=\"Widgets/AxesWidget\"] .display-panel .axis-control{width:1%;padding:0 4px;text-align:center}[data-component=\"Widgets/AxesWidget\"] .display-panel .axis-control .icon{font-size:12px}[data-component=\"Widgets/AxesWidget\"] .control-panel{background-color:#eee;padding:10px}[data-component=\"Widgets/AxesWidget\"] .control-panel .jog-x,[data-component=\"Widgets/AxesWidget\"] .control-panel .jog-y,[data-component=\"Widgets/AxesWidget\"] .control-panel .jog-z{font-size:24px}[data-component=\"Widgets/AxesWidget\"] .control-panel .jog-x{padding:0 5px}[data-component=\"Widgets/AxesWidget\"] .control-panel .jog-y{padding:5px}[data-component=\"Widgets/AxesWidget\"] .control-panel .jog-y .jog-y-plus{margin-bottom:10px}[data-component=\"Widgets/AxesWidget\"] .control-panel .jog-z{padding:5px}[data-component=\"Widgets/AxesWidget\"] .control-panel .jog-z .jog-z-plus{margin-bottom:10px}[data-component=\"Widgets/AxesWidget\"] .control-panel .form-group:last-child{margin-bottom:0}"; (require("browserify-css").createStyle(css, { "href": "components/widgets/axes.css"})); module.exports = css;
                            ...
                            _react2['default'].createElement(
                                ...
                                _react2['default'].createElement(
                                    ...
                                    _react2['default'].createElement(
                                        'button',
                                        { type: 'button', className: 'btn btn-sm btn-default' },
                                        _i18next2['default']._('Go Home (G0)')
                                    ),
                                    _react2['default'].createElement(
                                        'button',
                                        { type: 'button', className: 'btn btn-sm btn-default' },
...
var css = "[data-component=\"Widgets/SerialConsoleWidget\"] .control-panel{padding:10px}"; (require("browserify-css").createStyle(css, { "href": "components/widgets/serial-console.css"})); module.exports = css;
...
var SerialConsoleWidget = (function (_React$Component) {
    ...
    function SerialConsoleWidget() {
        ...
        _get(Object.getPrototypeOf(SerialConsoleWidget.prototype), 'constructor', this).apply(this, arguments);
    }

    _createClass(SerialConsoleWidget, [{
        key: 'getSerialPorts',
                ...
                header: {
                    title: _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                            'span',
                            null,
                            _i18next2['default']._('Serial Console')
                        )
                    ),
                    toolbar: {
                        buttons: ['toggle']
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                            ...
                            _react2['default'].createElement(
                                'label',
                                { className: 'control-label' },
                                _i18next2['default']._('Serial port:')
                            ),
                            _react2['default'].createElement(_reactSelect2['default'], {
...
var css = "[data-component=Workspace] .row[data-layout=primary-sidebar]{float:left}@media (max-width:767px){[data-component=Workspace] .row[data-layout=primary-sidebar]{float:none}}[data-component=Workspace] .row[data-layout=secondary-sidebar]{float:right}@media (max-width:767px){[data-component=Workspace] .row[data-layout=secondary-sidebar]{float:none}}[data-component=Workspace] .row[data-layout=main-content],[data-component=Workspace] .row[data-layout=primary-sidebar],[data-component=Workspace] .row[data-layout=secondary-sidebar]{padding:15px 0;min-height:500px}"; (require("browserify-css").createStyle(css, { "href": "components/workspace/workspace.css"})); module.exports = css;
